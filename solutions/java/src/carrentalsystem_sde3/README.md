# Carrentalsystem - SDE3 Lock-Free & Event-Driven Implementation

This directory represents the highest-tier, Staff-level (SDE3) implementation of the Carrentalsystem system.
